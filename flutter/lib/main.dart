    ...
    return Scaffold(
      ...
      body: Container(
        color: Color.fromARGB(
            255, 255, 84, 72), // Memberikan warna merah pada latar belakang
        child: Center(
                    ...
                    columns: [
                      DataColumn(
                        label: Text(
                          ...
                          style: TextStyle(
                              color: Colors
                                  .white), // Memberikan warna putih pada teks
                        ),
                      ),
                      DataColumn(
                        label: Text(
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 250, 250,
                                          250)), // Memberikan warna hitam pada teks
                                ),
                              ),
                              DataCell(
                                Text(
                                  item['name'].toString(),
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 250, 251,
                                          252)), // Memberikan warna biru pada teks
                                ),
                              ),
                              DataCell(
                                Text(
                                  ...
                                  style: TextStyle(
                                      color: const Color.fromARGB(255, 245, 247,
                                          245)), // Memberikan warna hijau pada teks
                                ),
                              ),
                            ],
                          ),
